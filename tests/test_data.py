...
td2 = literal_eval(r"""
{'Data':[{'Timestamp':'2009-11-10 23:00:00 +0000 UTC', 'Data':b'\x00\x00\x00\x000\xe9^Z\x00\x00\x00\x00l\xe9^Z\x00\x00\x00\x00\xa8\xe9^Z\x00\x00\x00\x00\xe4\xe9^Z\x00\x00\x00\x00'}]
}
""")
...
def test_results():
   ...
   print("q2.results[0][0]")
   assert q2.results[0][0] is not None
